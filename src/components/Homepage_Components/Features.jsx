...
const Features = memo(() => {
  return (
    <section
      ...
      className="bg-[#efeeea] dark:bg-[#080d10] py-8 sm:py-10 md:py-12 px-4 sm:px-6 lg:px-8"
    >
      <h2
        id="features-heading"
            ...
            return (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="mt-0.5 sm:mt-1 text-xs sm:text-sm text-gray-600 dark:text-[#7eaccb] line-clamp-2">
                    {feature.subtext}
                  </p>
                </div>
              </div>
