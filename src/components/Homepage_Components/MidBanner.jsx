...
const MidBanner = memo(() => {
  return (
    <section
      aria-label="Smart Tech mid-page banner"
      className="bg-[#eae4d5] dark:bg-[#060509] py-20 px-4"
    >
        ...
        <div className="relative overflow-hidden rounded-3xl grid grid-cols-1 lg:grid-cols-2 bg-white dark:bg-[#0b0f14] shadow-2xl">
          ...
          <div className="flex flex-col justify-center p-8 sm:p-12 lg:p-16">
            ...
            <h2 className="text-3xl font-extrabold leading-tight text-black sm:text-4xl lg:text-5xl dark:text-white">
              Smart Tech
              <span className="block text-[#155dfc]">Built for the Future</span>
            </h2>
            ...
            <Link
              ...
              className="mt-8 w-fit flex items-center gap-2 bg-[#155dfc] text-white font-semibold px-6 py-3 rounded-full shadow-lg transition-all duration-300 hover:scale-105 active:scale-95 hover:shadow-2xl"
            >
              Explore Products
          ...
          {/* RIGHT IMAGE — fixed height prevents CLS */}
          <div className="relative" style={{ minHeight: "320px" }}>
            <img
              src={Banner2}
              alt="Smart tech products — electronics at NovaShop"
              loading="lazy"
              width="600"
              height="400"
              decoding="async"
