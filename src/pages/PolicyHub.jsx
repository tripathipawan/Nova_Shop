...
const tabs = [
  {
    ...
    icon: FileText,
    content: `Welcome to NovaShop. By accessing or using our website, you agree to comply
...
Using this website signifies your acceptance of these terms.`,
  },
  {
    ...
    icon: ShieldCheck,
    content: `Your privacy matters to us. We are committed to protecting your personal data
...
You can request data removal or modification at any time.`,
  },
  {
    ...
    icon: Truck,
    content: `We aim to deliver your orders quickly and safely.
...
Free shipping is available on selected orders.`,
  },
  {
    ...
    icon: RefreshCcw,
    content: `Customer satisfaction is our priority.
...
Please contact support before initiating a return.`,
  },
  {
    ...
    label: "FAQs",
    icon: HelpCircle,
    content: `Q: Do you offer Cash on Delivery?
...
const PolicyHub = () => {
  ...
  useSEO({
    title: "Legal & Policy Information — NovaShop",
    description: "Read NovaShop's Terms & Conditions, Privacy Policy, Shipping Policy, Return & Refund Policy and FAQs.",
  });
    ...
    <section className="bg-[#efeeea] dark:bg-[#080d10] py-20">
      <div className="max-w-5xl px-4 mx-auto">
        ...
        <div
          ...
          className="flex flex-wrap justify-center gap-3 mb-5 bg-white dark:bg-[#11161c] p-5 rounded-2xl"
        >
          {tabs.map((tab) => {
            const Icon = tab.icon;
        ...
        <div className="bg-white dark:bg-[#11161c] rounded-2xl p-8 md:p-10 shadow-md">
          ...
          <h2
            ...
            className="mb-6 text-2xl font-extrabold text-center text-black dark:text-white"
          >
            {activeTab.label}
          </h2>
          ...
          <div className="pt-6 mt-12 text-center border-t border-black/10 dark:border-white/10">
            ...
            <address className="flex flex-col justify-center gap-6 text-sm font-medium sm:flex-row not-italic">
              <a
                href="mailto:support@novashop.com"
                className="flex items-center justify-center gap-2 text-black dark:text-white hover:text-[#155dfc] transition-colors"
              >
                <Mail size={14} className="text-[#155dfc]" aria-hidden="true" />
              ...
              <a
                ...
                className="flex items-center justify-center gap-2 text-black dark:text-white hover:text-[#155dfc] transition-colors"
              >
                <Phone size={14} className="text-[#155dfc]" aria-hidden="true" />
                +91 98765 43210
              </a>
            </address>
          </div>
