    ...
    <div className="min-h-screen bg-gray-50 dark:bg-[#0f0f0f] flex items-center justify-center px-4">
      <div className="text-center max-w-lg">
        ...
        <div className="relative mb-8 select-none">
          ...
          <div className="absolute inset-0 bg-gradient-to-br from-[#155dfc]/10 to-[#22edff]/10 blur-3xl rounded-full -z-10" aria-hidden="true" />
        </div>
        ...
        {/* Decorative dots */}
        <div className="flex justify-center gap-2 mt-12" aria-hidden="true">
          {[...Array(5)].map((_, i) => (
            <div
              key={i}
